...
\begin{enumerate}
  ...
  \color{red}{
    \begin{enumerate}
      ...
      \item Create a new viewport for setting up the correct xscale and yscale preparing for drawing, (if necessary) then draw the contents in the correct viewport.
