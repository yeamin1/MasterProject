...
\begin{figure}[h]
	\begin{center}
		...
		\caption{The structure of the \texttt{R} core graphics system, the \texttt{lattice}\citet{lattice}  and \texttt{ggplot2}\citet{ggplot2} and many others packages are built on top of the \textbf{grid} package. The \texttt{plotrix}\citet{plotrix} and \texttt{maps}\citet{maps} and many others packages are built on top of the \textbf{graphics} package. }
		\label{intro}
	\end{center}
\end{figure}
...
## time for for loop version of fille.contour()
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[height = 24cm, width = 16cm]{figure/montage/persp-montage1.png}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[height = 24cm, width = 12cm]{figure/montage/filled-contour-montage2.png}
