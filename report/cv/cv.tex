...
\cventry{Master \\ 
		...
		The core graphics system in \textbf{R} can be divided into two main packages, the older package called \textbf{graphics}-package and the newer package called \textbf{grid}-package. \\
...
\cventry{Honours}{Bayesian inference on forensic glass evidence}{}{}{}{
		If a person breaks glass, the tiny broken fragments will transfer to the person. If the glass is broken during the commission of the crime, then these tiny fragments can be used as forensic evidence. \\
