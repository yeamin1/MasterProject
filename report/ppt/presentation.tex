...
\begin{itemize}
  \item Ensure the plot drawn by \textbf{graphics} is identical to the plot drawn by \textbf{grid}
  \item Use our eyes to check the identity will be wasting time and not reliable
